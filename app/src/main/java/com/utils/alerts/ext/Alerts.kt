...
fun Context.inputNameAlert(title: String? = null, hint: String, inputType: InputType = InputType.Text, init: (StandardAlert.() -> Unit)? = null) = StandardAlert(this, AlertType.TwoEdit).apply {
    this.titleText = title
    this.hintText = hint
    this.inputType = inputType
    if (init != null) init()
